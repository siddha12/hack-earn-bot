...
BOT_TOKEN = "5152386212:AAEQ7MDI25b8YDXbCz9UML21rLaCtL0lAIw"
PAYMENT_CHANNEL = "@earningbagpay" #add payment channel here including the '@' sign
OWNER_ID = 1610719881 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@clickhere4earning"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
              #you can add as many channels here and also add the '@' sign before channel username
Daily_bonus = 9.200 #Put daily bonus amount here!
Mini_Withdraw = 1.5  #remove 0 and add the minimum withdraw u want to set
Per_Refer = 9.0001 #add per refer bonus here
